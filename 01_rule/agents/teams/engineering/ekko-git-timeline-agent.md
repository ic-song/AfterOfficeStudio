...
- Before pushing, check `git status --short` for deleted files.
- If deleted files are detected before pushing, verify whether they are deletion-approved and whether `90_기록실/삭제대기/삭제대기-이력.ko.md` has the actual deletion date and deletion status.
