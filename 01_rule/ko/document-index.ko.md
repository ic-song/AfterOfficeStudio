...
| `01_rule/INDEX.md` | 규칙 문서 폴더별 인덱스 |
| `10_아이디어/` | `50_프로젝트/`로 승격되기 전 프로젝트 후보 아이디어 |
| `10_아이디어/INDEX.md` | 아이디어 폴더별 인덱스 |
| `50_프로젝트/` | 실제 프로젝트와 프로젝트 템플릿 |
| `50_프로젝트/INDEX.md` | 프로젝트 폴더별 인덱스 |
| `90_기록실/` | 회의록, 문서 이력, 삭제대기 이력 같은 운영 기록 |
| `90_기록실/INDEX.md` | 기록실 폴더별 인덱스 |
| `99_아카이브/` | 보관 문서 또는 삭제 승인 대기 문서 |
| `99_아카이브/INDEX.md` | 아카이브 폴더별 인덱스 |
...
| `90_기록실/문서이력/문서이력.md` | `90_record/document-history.md` | 문서 생성, 이동, 이름 변경 이력 |
...
| `10_아이디어/INDEX.md` | 아이디어 목록과 상태를 관리하는 폴더별 인덱스 |
...
| 문서 | 용도 |
| --- | --- |
| `50_프로젝트/INDEX.md` | 활성 프로젝트와 템플릿 목록을 관리하는 폴더별 인덱스 |
| `50_프로젝트/project-template/INDEX.md` | 프로젝트 템플릿 AI 라우팅 인덱스 |
| `50_프로젝트/project-template/안내.md` | 프로젝트 개요 템플릿 |
| `50_프로젝트/project-template/기획.md` | 기획과 MVP 범위 템플릿 |
| `50_프로젝트/project-template/수익모델.md` | 수익모델과 close 기준 템플릿 |
| `50_프로젝트/project-template/작업.md` | 작업 목록 템플릿 |
| `50_프로젝트/project-template/결정.md` | 결정 기록 템플릿 |
...
| 문서 | 용도 |
| --- | --- |
| `99_아카이브/INDEX.md` | 보관 및 삭제대기 위치를 안내하는 폴더별 인덱스 |
