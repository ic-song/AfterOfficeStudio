...
```text
1. Collect the idea.
2. Swain reviews direction and project potential.
3. Shen organizes the work flow.
4. Lux drafts the planning document.
5. Review business model possibilities when needed.
6. Viktor reviews technical feasibility.
7. Senna organizes status and records.
8. Create a project under 50_프로젝트/ when needed.
9. Record final decisions in DECISIONS.md.
```
...
If the idea is worth managing as a project, create a folder under `50_프로젝트/`. At the early stage, use the `50_프로젝트/project-template/` structure as the minimum standard.
