...
| `ai/sub-agents/operation/ekko.git-timeline-keeper.md` | Git 이력, 커밋, 브랜치, 푸시 관리 담당 |
...
| 문서 | 용도 |
| --- | --- |
| `human/meeting-note-rules.ko.md` | 회의록과 회의록 내부 `녹취록` 섹션 작성 기준 |
| `human/meetings/` | 전체 운영 또는 프로젝트 미지정 회의록 |
| `projects/{project}/meetings/` | 특정 프로젝트 회의록 |
